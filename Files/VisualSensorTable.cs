...
namespace FalconDatabase.Files
{
    ...
    public class VisualSensorTable : AppFile, IEquatable<VisualSensorTable>
    {
        #region Properties
        /// <summary>
        /// Collection of <see cref="VisualSensorDefinition" /> Entries exported from the Database.
        /// </summary>
        ...
        #region Fields
        private Collection<VisualSensorDefinition> dbObjects = [];
        private string schemaFile =
            Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), @"XMLSchemas\VSD.xsd");
        #endregion Fields
        ...
        protected override bool Read(string data)
        {
            ...
            {
                Utilities.Logging.ErrorLog.CreateLogFile(ex, "This Error occurred while reading the VSD Table.");
                reader.Close();
                throw;
            }
        ...
        protected override byte[] Write()
        {
            ...
            {
                Utilities.Logging.ErrorLog.CreateLogFile(ex, "This Error occurred while writing the VSD Table.");
                stream.Close();
                throw;
            }
        }
        ...
        public override bool Equals(object? other)
        {
            ...
            VisualSensorTable? comparator = other as VisualSensorTable;
        ...
        #region Constructors
        /// <summary>
        /// Default Constructor for the <see cref="VisualSensorTable"/> object.
        /// </summary>
        public VisualSensorTable()
        {
            _FileType = ApplicationFileType.DatabaseVSD;
            _StreamType = FileStreamType.XML;
            _IsCompressed = false;
        }
        /// <summary>
        /// Initializes an instance of the <see cref="VisualSensorTable"/> component of the Database with the data contained in the file at <paramref name="filePath"/>.
        /// </summary>
