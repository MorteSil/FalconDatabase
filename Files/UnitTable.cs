...
namespace FalconDatabase.Files
{
    ...
    /// </summary>
    public class UnitTable : AppFile, IEquatable<UnitTable>
    {
        #region Properties
        /// <summary>
        ...
        protected override bool Read(string data)
        {
            ...
            {
                Utilities.Logging.ErrorLog.CreateLogFile(ex, "This Error occurred while reading the UCD Table.");
                reader.Close();
                throw;
            }
        ...
        protected override byte[] Write()
        {
            ...
            {
                Utilities.Logging.ErrorLog.CreateLogFile(ex, "This Error occurred while writing the UCD Table.");
                stream.Close();
                throw;
            }
        }
        ...
        public UnitTable()
        {
            _FileType = ApplicationFileType.DatabaseUCD;
