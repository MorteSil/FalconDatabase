...
namespace FalconDatabase.Files
{
    ...
    /// </summary>
    public class RadarTable : AppFile, IEquatable<RadarTable>
    {
        #region Properties
        /// <summary>
        /// Collection of <see cref="RadarDefinition" /> Entries exported from the Database.
        /// </summary>
        public Collection<RadarDefinition> Radars { get => dbObjects; set => dbObjects = value; }
        /// <summary>
        /// Radar Component of the Database in Raw Data Format.
        /// </summary>
        public DataTable RadartDataTable
        {
            get
            {
                DataSet dataSet = new();
        ...
        #region Fields
        private Collection<RadarDefinition> dbObjects = [];
        private readonly string schemaFile =
            Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), @"XMLSchemas\RCD.xsd");
        #endregion Fields
        ...
        protected override bool Read(string data)
        {
            ...
            {
                Utilities.Logging.ErrorLog.CreateLogFile(ex, "This Error occurred while reading the RCD Table.");
                reader.Close();
                throw;
            }
        ...
        protected override byte[] Write()
        {
            ...
            {
                Utilities.Logging.ErrorLog.CreateLogFile(ex, "This Error occurred while writing the RCD Table.");
                stream.Close();
                throw;
            }
        }
        ...
        public override bool Equals(object? other)
        {
            ...
            if (other is not RadarTable comparator)
                return false;
            else
        ...
        public RadarTable()
        {
            _FileType = ApplicationFileType.DatabaseRCD;
