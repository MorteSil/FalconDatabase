...
namespace FalconDatabase.Files
{
    ...
    /// </summary>
    public class AircraftTable : AppFile, IEquatable<AircraftTable>
    {
        #region Properties
        /// <summary>
        /// Collection of <see cref="AircraftDefinition" /> Entries exported from the Database.
        /// </summary>
        public Collection<AircraftDefinition> Aircraft { get => dbObjects; set => dbObjects = value; }
        /// <summary>
        ...
        {
            _FileType = ApplicationFileType.DatabaseACD;
