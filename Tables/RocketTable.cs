...
namespace FalconDatabase.Tables
{
    ...
    /// </summary>
    public class RocketTable : AppFile, IEquatable<RocketTable>
    {
        #region Properties
        /// <summary>
        /// Collection of <see cref="RocketDefinition" /> Entries exported from the Database.
        /// </summary>
        public Collection<RocketDefinition> Rockets { get => dbObjects; set => dbObjects = value; }
        /// <summary>
        /// Rocket Component of the Database in Raw Data Format.
        /// </summary>
        public DataTable RocketDataTable
        {
            get
            {
                DataSet dataSet = new();
        ...
        #region Fields
        private Collection<RocketDefinition> dbObjects = [];
        private readonly string schemaFile =
            Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), @"XMLSchemas\RKT.xsd");
        #endregion Fields
        ...
        protected override bool Read(string data)
        {
            ...
            {
                Utilities.Logging.ErrorLog.CreateLogFile(ex, "This Error occurred while reading the RKT Table.");
                reader.Close();
                throw;
            }
        ...
        protected override byte[] Write()
        {
            ...
            {
                Utilities.Logging.ErrorLog.CreateLogFile(ex, "This Error occurred while writing the RKT Table.");
                stream.Close();
                throw;
            }
        }
        ...
        public override bool Equals(object? other)
        {
            ...
            if (other is not RocketTable comparator)
                return false;
            else
        ...
        public RocketTable()
        {
            _FileType = ApplicationFileType.DatabaseRKT;
