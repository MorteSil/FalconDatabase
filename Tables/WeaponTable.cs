...
namespace FalconDatabase.Tables
{
    ...
    /// </summary>
    public class WeaponTable : AppFile, IEquatable<WeaponTable>
    {
        #region Properties
        /// <summary>
        /// Collection of <see cref="WeaponDefinition" /> Entries exported from the Database.
        /// </summary>
        public Collection<WeaponDefinition> Weapons { get => dbObjects; set => dbObjects = value; }
        /// <summary>
        /// Aircraft Component of the Database in Raw Data Format.
        /// </summary>
        public DataTable WeaponDataTable
        {
            get
            {
                DataSet dataSet = new();
        ...
        #region Fields
        private Collection<WeaponDefinition> dbObjects = [];
        private readonly string schemaFile =
            Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), @"XMLSchemas\WCD.xsd");
        #endregion Fields
        ...
        protected override bool Read(string data)
        {
            ...
            {
                Utilities.Logging.ErrorLog.CreateLogFile(ex, "This Error occurred while reading the WCD Table.");
                reader.Close();
                throw;
            }
        ...
        protected override byte[] Write()
        {
            ...
            {
                Utilities.Logging.ErrorLog.CreateLogFile(ex, "This Error occurred while writing the WCD Table.");
                stream.Close();
                throw;
            }
        }
        ...
        public override bool Equals(object? other)
        {
            ...
            if (other is not WeaponTable comparator)
                return false;
            else
        ...
        public WeaponTable()
        {
            _FileType = ApplicationFileType.DatabaseWCD;
