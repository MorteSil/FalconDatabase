using FalconDatabase.Attributes;
using System;
...
namespace FalconDatabase.Enums
{
    ...
    /// </summary>
    public enum Classtable_Class
    {
        /// <summary>
        /// Abstract Object that cannot be interacted with.
        /// </summary>
    ...
    /// iterating collections by based on the value: for (int i = 1; i < (int)AIR_UNITS; i++)...
    /// </summary>
    public enum Classtable_Type
    {
        /// <summary>
        ...
        // undersea/unit
        /// <summary>
        /// A single sea vessel not attached to a larger group.
        /// </summary>
